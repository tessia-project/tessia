...
"""
Unit test for volume_types resource module
"""
...
# CODE
#
class TestVolumeType(TestSecureResource):
    """
    Validates the VolumeType resource
    """
    ...
    def _entry_gen():
        ...
        while True:
            data = {
                'name': 'VOLTYPE {}'.format(index),
                'desc': ('- Description of volume type {} with some '
