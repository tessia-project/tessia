...
configuration details. See also the [Permissions model](permissions_model.md) page to understand how to manage multiple users.
...
The tool is now ready for use, enjoy!
