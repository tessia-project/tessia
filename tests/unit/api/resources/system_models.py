...
"""
Unit test for system_models resource module
"""
...
# CODE
#
class TestSystemModel(TestSecureResource):
    """
    ...
    def _entry_gen():
        ...
        while True:
            data = {
                'name': 'MODEL_SUBMODEL_{}'.format(index),
                'arch': 's390x',
                'model': 'MODEL',
                'submodel': 'SUBMODEL_{}'.format(index),
                'desc': ('- Description of MODEL_SUBMODEL_{} with some '
    ...
    def test_list_filtered(self):
        ...
        filter_values = {
            ...
            'submodel': 'some_submodel_for_filter',
