...
$ hostname --fqdn
myhost
$ cd /home/user/work/git/tessia/tessia-engine && python3 -c 'from setup import gen_version; print(gen_version())'
17.713.740+devd40c703
INFO: [init] tag for images is 17.713.740-devd40c703
INFO: new stage: build
$ mktemp -p /tmp -d
/tmp/tmp.UiFhfNktQn
$ cd /home/user/work/git/tessia/tessia-engine && git remote get-url origin
git@gitlab.com:tessia/tessia-engine.git
INFO: [build] detected git repo name is tessia-engine
INFO: [build] creating mirror of git repo
$ cd /tmp/tessia-build-m78bhj_0 && git clone --mirror /home/user/work/git/tessia/tessia-engine tessia-engine.git
Klone in Bare-Repository 'tessia-engine.git' ...
Fertig.
INFO: [build] sending git mirror to myhost
INFO: [build] preparing context dir at /tmp/tmp.UiFhfNktQn/tessia-cli
$ cp -r /tmp/tmp.UiFhfNktQn/tessia-engine.git /tmp/tmp.UiFhfNktQn/tessia-cli/assets/tessia-engine.git
...
Step 1/9 : FROM ubuntu:latest
 ---> d355ed3537e9
Step 2/9 : ARG git_repo=/assets/tessia-engine.git
 ---> Using cache
 ---> 322ccdc8004c
...
Successfully tagged tessia-engine:17.713.740-devd40c703
...
dd3cfb801868        tessia-engine:17.713.740-devd40c703   "/entrypoint"            5 minutes ago       Up 5 minutes        0.0.0.0:80->80/tcp, 0.0.0.0:5000->5000/tcp   tessia_engine_1
```
...
[user@myhost tessia-engine]$ docker exec tessia_engine_1 supervisorctl restart tessia-api
tessia-api: stopped
tessia-api: started

# confirm that the service is really running
[user@myhost tessia-engine]$ docker exec tessia_engine_1 supervisorctl status
...
[user@myhost tessia-engine]$ docker exec -ti tessia_engine_1 /bin/bash
