...
"""
Unit test for system_states resource module
"""
...
# CODE
#
class TestSystemState(TestSecureResource):
    """
    Validates the SystemState resource
    """
    ...
    def _entry_gen():
        ...
        while True:
            data = {
                'name': 'SYSTEMSTATE {}'.format(index),
                'desc': ('- Description of system state {} with some '
    ...
    def test_add_update_conflict(self):
        """
        Test two scenarios:
        1- add an item with a state that already exists
        2- update an item to a state that already exists
        """
