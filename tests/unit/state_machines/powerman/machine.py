...
class TestPowerManagerMachine(TestCase):
    ...
    def _assert_poweroff_action(self, hyp_type, hyp_prof_obj, guest_obj,
        ...
        hyp_args = (
            ...
            hyp_prof_obj.system_rel.hostname, hyp_prof_obj.credentials['user'],
    ...
    def test_multiple_actions(self):
        ...
        prof_obj = SystemProfile.query.filter_by(
            name='dasd1', system_id=system_obj.id).one()
    ...
    def test_invalid_profile_no_root(self):
        ...
        prof_obj = SystemProfile.query.filter_by(
            default=True, system_id=system_obj.id).one()
    ...
    def test_invalid_system(self):
        ...
        hyp_prof = SystemProfile.query.filter_by(
            id=system_obj.hypervisor_id, default=True).one()
        cpc_prof = SystemProfile.query.filter_by(
            id=hyp_obj.hypervisor_id, default=True).one()
        request = str({
            'systems': [
                {
                    'action': 'poweron',
    ...
    def test_poweron_already_up(self):
        ...
        prof_obj = SystemProfile.query.filter_by(
            default=True, system_id=system_obj.id).one()
        hyp_prof_obj = SystemProfile.query.filter_by(
            id=system_obj.hypervisor_id, default=True).one()
