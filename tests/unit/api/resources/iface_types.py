...
"""
Unit test for iface_types resource module
"""
...
# CODE
#
class TestIfaceType(TestSecureResource):
    """
    Validates the IfaceType resource
    """
    ...
    def _entry_gen():
        ...
        while True:
            data = {
                'name': 'IFACETYPE {}'.format(index),
                'desc': ('- Description of iface type {} with some '
